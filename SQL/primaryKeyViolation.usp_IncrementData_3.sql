...
if OBJECT_ID('[primaryKeyViolation].[usp_IncrementData_3]') IS NULL
begin

	exec('create procedure [primaryKeyViolation].[usp_IncrementData_3] as select 1/0 as [shell] ')

end
go
 
alter procedure [primaryKeyViolation].[usp_IncrementData_3]
(
	@id int
)
as
